-- Update get_products_enhanced to respect show_on_products field in on_sale_only filter
    ...
    AND (
      ...
      OR EXISTS (
        ...
        WHERE dc.is_active = true
          AND dc.show_on_products = true  -- ADDED: Only consider product sale discounts
