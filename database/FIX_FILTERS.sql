-- =============================================
-- FIX: Product filters not working - Missing get_filter_options function
-- Run this in Supabase SQL Editor to fix filter functionality
-- =============================================

-- Create the get_filter_options function
...
BEGIN
  ...
  SELECT
    ...
    -- Products on sale (have active discounts)
    COUNT(DISTINCT
      CASE
        WHEN EXISTS (
