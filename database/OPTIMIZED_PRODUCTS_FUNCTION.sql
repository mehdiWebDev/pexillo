-- =============================================
-- PERFORMANCE OPTIMIZED get_products_enhanced
-- Uses UUIDs for maximum performance with proper indexes
-- =============================================
...
-- Create optimized function with UUID parameters
...
-- Create optimized indexes for filtering
...
SELECT COUNT(*) as product_count FROM get_products_enhanced();