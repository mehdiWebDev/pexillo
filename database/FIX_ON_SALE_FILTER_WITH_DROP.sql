...
CREATE OR REPLACE FUNCTION get_products_enhanced(
  ...
  category_id_filter UUID[] DEFAULT NULL,  -- Note: parameter name is category_id_filter
  badge_filter TEXT[] DEFAULT NULL,
  featured_only BOOLEAN DEFAULT false,
  in_stock_only BOOLEAN DEFAULT false,
  on_sale_only BOOLEAN DEFAULT false,
  sort_by_param TEXT DEFAULT 'created_at',  -- Note: parameter name is sort_by_param
  sort_order_param TEXT DEFAULT 'DESC',     -- Note: parameter name is sort_order_param
