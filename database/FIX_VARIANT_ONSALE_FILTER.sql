-- =============================================
-- FIX: On Sale filter not detecting variant-specific discounts
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'VARIANT DISCOUNT FIX APPLIED';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Changes:';
  RAISE NOTICE '✓ On Sale filter now detects variant-specific discounts';
  RAISE NOTICE '✓ Products with variant discounts will show when filtering by On Sale';
  RAISE NOTICE '✓ Product count in On Sale filter includes variant discounts';
  RAISE NOTICE '========================================';
END $$;